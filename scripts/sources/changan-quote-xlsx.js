...
const FILES = [
  { name: '长安报价单0310A-哈里.xlsx', sourceType: 'changan-quote-xlsx' },
  { name: '长安报价单0310A-哈里-1.xlsx', sourceType: 'changan-quote-xlsx' },
];
...
export function harvestChanganQuoteXLSX() {
  const rows = [];
  let totalRows = 0;
  ...
  return { rows, totalRows, sourceName: 'changan-quote-xlsx' };
}